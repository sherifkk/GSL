...
public class TeamResultsFragment extends Fragment {
  ...
  public static TeamResultsFragment getInstance(String title) {
    TeamResultsFragment fra = new TeamResultsFragment();
  ...
  protected void initData() {
    ...
    mid1 = new ArrayList<>();
    mid2 = new ArrayList<>();
    String URL = "http://gsl-gec.esy.es/gsl/teamresults.php?tid="+mTitle;
        ...
        try {
          ...
          if (jsonArray.length() > 0) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
              ...
              mMatches.add(jsonObject.getString("team1")+ " " + jsonObject.getString("goal1")+ "-" +jsonObject.getString("goal2") +" "+jsonObject.getString("team2"));
              mDate.add(jsonObject.getString("datetime"));
              mNo.add(jsonObject.getString("mid"));
              mWK.add("MatchWeek "+jsonObject.getString("matchweek"));
            ...
            mRecyclerView.setAdapter(mAdapter = new ResultsRecyclerAdapter(mRecyclerView.getContext(),mMatches,mDate,mNo,mWK,mshort1,mshort2,mid1,mid2));
          }
