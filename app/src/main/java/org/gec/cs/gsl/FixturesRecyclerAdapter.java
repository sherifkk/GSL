...
public class FixturesRecyclerAdapter extends RecyclerView.Adapter<FixturesRecyclerAdapter.MyViewHolder> {
  private Context mContext;
  private List<String> mMatches,mDate,mNos,mWk,mS1,ms2,mid1,mid2;
  private Context context;

  public FixturesRecyclerAdapter(Context context, List<String> matches, List<String> date, List<String> no, List<String> wk, List<String> s1, List<String> s2, List<String> id1, List<String> id2) {
    mContext = context;
    mMatches = matches;
    mDate = date;
    mNos = no;
  ...
  public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
        mContext).inflate(R.layout.item_fixtures, parent, false));
    return holder;
  }
  ...
  public void onBindViewHolder(MyViewHolder holder, final int position) {
    ...
    holder.mWk.setText(mWk.get(position));
  ...
  class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(View view) {
      ...
      mWk = (TextView) view.findViewById(R.id.textWk);
    }
  }
}