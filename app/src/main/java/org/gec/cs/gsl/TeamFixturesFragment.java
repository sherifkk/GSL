...
public class TeamFixturesFragment extends Fragment {
  ...
  public static TeamFixturesFragment getInstance(String title) {
    TeamFixturesFragment fra = new TeamFixturesFragment();
  ...
  protected void initData() {
    ...
    String URL = "http://gsl-gec.esy.es/gsl/teamfixtures.php?tid="+mTitle;
